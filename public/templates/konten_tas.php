                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="sec-img mt-5">
                                <img name="foto"
                                    src="../admin/templates/tas/file/<?php echo $row['foto']; ?>"
                        ...
                        <div id="nameProduct" class="col-lg-7">
                            <div class="sec-text">
                                ...
                                <p>
                                    <!-- <b class="">Jenis: <?php echo $row['jenis_barang']; ?></b> -->
                                    Jenis Tas: <b class="m-2"><?php echo $row['jenis_barang']; ?></b>
                                    <input type="hidden" name="jenis_barang" value="<?php echo $row['jenis_barang']; ?>">
                                </p>
                                <p>
                                                        ...
                                                        <div class="container mt-3 border-top border-danger">
                                                            <div class="row">
                                                                ...
                                                                <div class="box-body">
                                                                    ...
                                                                    <input type="hidden" name="jenis_barang" value="TAS">
                                                                </div>
                                                                <!-- </form>                             -->
                                                            </div>
                                                        </div>
