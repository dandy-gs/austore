...
if (isset($_GET['id'])) {
    if ($_GET['id'] != "") {
        ...
        $query = mysqli_query($conn, "DELETE FROM sepatu_rajut WHERE id='$id'");
        if ($query) {
            header("location:../../index.php?hal2=sepatu&pesan=hapus");
        } else {
            header("location:../../index.php?hal2=sepatu&pesan=gagalhapus");
        }
    } else {
