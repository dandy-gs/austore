...
if ($foto_size > 20097152) {
    ...
    header("location:./index.php?hal=baju&pesan=size");
} else {
    ...
    if ($foto_nama != "") {
        ...
        $foto_nama_new = $tanggal . 'baju' . $foto_nama;
        ...
        if (in_array($ekstensi, $ekstensi_izin) === true) {
            ...
            $query = mysqli_query($conn, "INSERT INTO baju_rajut VALUES ('','$nama',
                                                                        '$jenis',
                                                                        '$harga',
                                                                        '$foto_nama_new',
                                                                        '$lama_buat')");
            ...
            if ($query) {
                header("location:../../index.php?hal=baju&pesan=berhasil");
            } else {
                header("location:../../index.php?hal=baju&pesan=gagal");
            }
        } else {
            // Jika ekstensinya tidak sesuai dengan apa yg kita tetapkan maka error
            header("location:./index.php?hal=baju&pesan=ekstensi");
        }
    } else {
