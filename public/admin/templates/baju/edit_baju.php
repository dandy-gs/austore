<div class="page-header">
    <h1>Tambah Baju</h1>
    <small>Dashboard / Tambah Baju</small>
</div>
    ...
    <div class="analytics">
        ...
        <div class="records table-responsive">
            <div class="box box-primary">
                ...
                <form role="form" action="templates/baju/proses_edit_baju.php" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
