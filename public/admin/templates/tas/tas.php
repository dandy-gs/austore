    ...
    <div class="records table-responsive">
        <div class="record-header">
            <div class="add">
                ...
                <a href="./index.php?hal1=tambah_tas">
        ...
        <div>
            <table width="100%">
                ...
                <tbody>
                    <?php
                    include "config.php";
                    $hasil = mysqli_query($conn, "select * from tas_rajut");
                    $no = 1;
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?hal1=edit_tas&id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-warning" name=""> <i class="fa fa-pencil"></i> Edit</button></a>
                                <button><a onclick="return confirm('Anda Yakin...?')" href="./templates/tas/hapus_tas.php?id=<?php echo $row['id'] ?>">
